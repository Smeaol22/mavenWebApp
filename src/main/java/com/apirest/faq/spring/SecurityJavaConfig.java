...
import com.apirest.faq.spring.security.MySavedRequestAwareAuthenticationSuccessHandler;
import com.apirest.faq.spring.security.RestAuthenticationEntryPoint;

@Configuration
@EnableWebSecurity
@EnableGlobalMethodSecurity(prePostEnabled = true)
@ComponentScan("com.apirest.spring.security")
